...
class TensorMainPage(BasePage):
    ...
    def go_to_tensor_about_link(self):
        about_link = self.browser.find_element(By.CSS_SELECTOR, "#container > div.tensor_ru-content_wrapper > div > div.tensor_ru-Index__block4-bg > div > div > div:nth-child(1) > div > p:nth-child(4) > a")
